  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <h2 className="text-xl font-semibold text-blue-600 mb-4">Cuentas Corrientes</h2>
          <p className="text-base text-gray-700 leading-relaxed">Consulta los saldos y movimientos de tus clientes.</p>
        </div>
        <div
          onClick={() => navigate('/vendedor-pedidos-ventas')}
          className="bg-white border border-gray-200 rounded-xl p-8 text-center text-inherit transition-all duration-300 ease-in-out cursor-pointer shadow-lg hover:-translate-y-2 hover:shadow-xl hover:border-blue-500"
        >
          <h2 className="text-xl font-semibold text-blue-600 mb-4">Pedidos de Ventas</h2>
          <p className="text-base text-gray-700 leading-relaxed">Visualiza el historial de pedidos y crea nuevos.</p>
        </div>
        <div
